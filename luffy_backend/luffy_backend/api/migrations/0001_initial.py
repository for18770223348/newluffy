# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-02-27 01:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(blank=True, help_text='不填用户的话代表给未注册用户发通知', null=True, on_delete=django.db.models.deletion.CASCADE, to='api.Account')),
                ('content_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.ContentType')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='course_section',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.CourseSection'),
        ),
        migrations.AddField(
            model_name='article',
            name='source',
